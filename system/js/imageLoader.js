...
//console.log(oldValue);
    ...
    function remove_img(imgHolder) {
        ...
        $(imgHolder).find(".user_thumb").attr("src", "../../application/user_uploads/NO-IMAGE-AVAILABLE-ICON.jpg");
                ...
                data: {img_revert:'img-revert',field_name:fieldName}
                    ...
                    .done(function (msg) {
                       ...
                       if(msg){
                        ...
                        $(imgHolder).find(".user_thumb").attr("src", "../../application/user_uploads/" + msg);
